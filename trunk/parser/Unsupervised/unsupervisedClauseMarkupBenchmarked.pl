...
my $kb = $ARGV[4]; #glossary used as KnowledgeBase
$prefix =~ s#-#_#g;
...
my $PREPOSITION ="above|across|after|along|among|amongst|around|as|at|before|behind|below|beneath|between|beyond|by|during|for|from|in|into|near|of|off|on|onto|out|outside|over|per|than|through|throughout|toward|towards|up|upward|with|without";
...
#print stdout "Reading sentences 3:\n";
addnumbers(); #4/11/09
#print stdout "Reading sentences 4:\n";
addclusterstrings(); #4/11/09
#print stdout "Reading sentences 5:\n";
addpropernouns(); #6/2/09
#print stdout "Reading sentences: 6\n";
posbysuffix();
#print stdout "Reading sentences 7:\n";
resetcounts();
#print stdout "Reading sentences 8:\n";
###############################################################################
...
#print stdout "Reading sentences 9:\n";
...
sub populateunknownwordstable{
	...
	print stdout "Total words = $count\n";
}
