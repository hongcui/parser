...
public class Type3Transformation extends Thread {
	...
	private File source = new File(Registry.SourceDirectory+"\\cleaned");
	...
	Type3Transformation(ProcessListener listener, Display display, 
	...
	public static void main(String[] args) {
		...
		Type3Transformation tpm = new Type3Transformation(null, null, null, "bhl_2vs", null);
