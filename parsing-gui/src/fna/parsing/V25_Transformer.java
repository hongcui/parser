...
public class V25_Transformer {
	private static final Logger LOGGER = Logger.getLogger(V25_Transformer.class);
	...
	public static void main(String[] args) throws Exception{
		...
		outputStream = new ObjectOutputStream(new FileOutputStream("C:\\Users\\mohankrishna89\\Desktop\\FNA25\\namemapping.bin"));
		String taxonname = null;
		Hashtable mapping = new Hashtable();
		//File extracted = new File("d:/Library Project/V8/Extracted");
		File extracted = new File("C:\\Users\\mohankrishna89\\Desktop\\FNA25\\target\\Extracted");
		File[] files = extracted.listFiles();
		for(int i = 1; i<=files.length; i++){
			count = i;
			SAXBuilder builder = new SAXBuilder();
			//Document doc = builder.build("d:/Library Project/V8/Extracted/" + i + ".xml");
			Document doc = builder.build("C:\\Users\\mohankrishna89\\Desktop\\FNA25\\target\\Extracted\\" + i + ".xml");
			//Document doc = builder.build("C:\\Users\\mohankrishna89\\Desktop\\FNA25\\target\\Extracted\\" + "16.xml");
			...
			V25_Transformer transformer = new V25_Transformer();
	...
	private String processparagraph(List paralist) throws Exception{
		...
		while(paraiter.hasNext()){
			...
			{
				if(text.matches("\\s*Grass Phylogeny Working Group\\s*")){
			...
			//else if(familydetecter == 1)
			...
			else if((bolddetecter == 1&!text.matches("[0-9]+\\w*\\..+")&&keylast!=1&&(!(text.matches(".*\\[p\\..*\\].*")||text.matches(".*\\[not.*\\].*"))))&&!filebeg){//Description
				...
				File descriptionout = new File("C:\\Users\\mohankrishna89\\Desktop\\FNA25\\target\\description\\" + count + ".txt");//why am i doing this?
	...
	private void output(int i) throws Exception {
		...
		String file = "C:\\Users\\mohankrishna89\\Desktop\\FNA25\\target\\Transformed\\" + i + ".xml";
		//String file = "C:\\Users\\mohankrishna89\\Desktop\\FNA25\\target\\Transformed\\" + i +taxonname+ ".xml";
	...
	private void outputauthor(int i) throws Exception {
		//XMLOutputter outputter = new XMLOutputter();
		//String file = "d:/Library Project/V8/Transformed/" + i + ".xml";
		String file = "C:\\Users\\mohankrishna89\\Desktop\\FNA25\\author.txt";
		try{
			  // Create file 
